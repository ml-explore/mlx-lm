...
class Model(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        self.language_model = qwen3_moe.Model(qwen3_moe.ModelArgs.from_dict(args.text_config))
    ...
    def sanitize(self, weights):
        ...
        for l in range(self.language_model.args.num_hidden_layers):
            ...
            if gate_up_key in weights:
                ...
                weights[f"{prefix}.switch_mlp.gate_proj.weight"] = gate_up[..., :mid].swapaxes(-2, -1)
                weights[f"{prefix}.switch_mlp.up_proj.weight"] = gate_up[..., mid:].swapaxes(-2, -1)
                weights[f"{prefix}.switch_mlp.down_proj.weight"] = weights.pop(f"{prefix}.experts.down_proj").swapaxes(-2, -1)
