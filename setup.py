...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "mlx_lm.quant.awq = mlx_lm.quant.awq:main",
            "mlx_lm.quant.dwq = mlx_lm.quant.dwq:main",
            "mlx_lm.quant.dynamic_quant = mlx_lm.quant.dynamic_quant:main",
            "mlx_lm.quant.gptq = mlx_lm.quant.gptq:main",
